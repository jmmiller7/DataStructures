...
public class Demo {
	...
	public static void main(String[] args)
	{
		...
		fitness.members.removeMembership("MWehking14");
		System.out.println(getTots());
		
		
		System.out.println("--------- Determine Best Year After 2011 ----");
		double largestInc = (fitness.getLargestPercentageMembershipIncreaseSince(2011));
		System.out.println("Percent Increase: " + largestInc + " %");
		
		
		System.out.println("\n----------- Remove all 2013 Members -------");
		fitness.members.removeMembershipOfAYear(2013);
		System.out.println(getTots());
