...
public class Club extends LinkedList<Membership>implements IClub {
	...
	// or returns -1 otherwise.
	{
		...
		Membership temp = new Membership(memberID, 0);
		position = members.contains(temp);
		return position;
	}

	// get largest percentage membership increase-----------------------
	public double largestPrcntIncreaseSince(int year)
