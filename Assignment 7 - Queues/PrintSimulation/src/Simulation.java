...
public class Simulation {
	...
	public static void main(String[] args) {
		...
		simulationPd = 10000; // Simulation period of 10000 seconds, or 167
								// minutes

		PrintTask.setMaxNumPages(); // Generates random number 1<x<100 for max
									// num pages
	...
	public static void displayResults() {
		...
		System.out.println(
				"Average wait time:\t" + avgWaitTime + " second(s) \t ==> " + d.format(avgWaitTime / 60) + " minutes");
		System.out.println();
